...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					...
					<li><a href="locateus.php">ค้นหาหมอ</a></li>
					<li><a href="#home">หน้าหลัก</a></li>
				</ul>
			</div>
			<div class="center">
		
				<button onclick="document.getElementById('id01').style.display='block'" style="position:absolute;top:60%;left:18%">เข้าสู่ระบบ</button>
				
			</div>	
			<div class="footer">
				<ul style="position:absolute;top:93%;background-color:black">
					<li><a href="admin/alogin.php">Admin เข้าสู่ระบบ</a></li>
					<li><a href="admin/mlogin.php">Manager เข้าสู่ระบบ</a></li>
				</ul>
			</div>
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="post" action="cover.php">
    ...
    <div class="container" style="background-color:#f1f1f1">
      ...
      <button onclick="document.getElementById('id02').style.display='block';document.getElementById('id01').style.display='none'" style="float:right">ไม่มีบัญชี?</button>
    </div>
  </form>
</div>
