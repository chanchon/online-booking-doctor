...
<div class="header">
				<ul>
					...
					<li><a href="mgrmenu.php">หน้าหลัก</a></li>
				</ul>
</div>
<div class="container" style="width:100%;background-image:url(2.jpg)">
	<div class="container" style="background-color:grey">
	<form method="post">
	  <button type="button" name="change" onclick="window.location.href='changebookingstatus.php'">ปลี่ยน/ดูสถานะการนัด</button>
	  <button type="submit" name="logout" style="float:right">ออกจากระบบ</button>
	</form>
    </div>
</div>
<?php
