...
<body style="background-image:url(2.jpg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="logo.png" width="30px" height="30px"><strong> นัดหมอ </strong>ออนไลน์</a></li>
			<li><a href="cover.php">หน้าหลัก</a></li>
		</ul>
	</div>
	<form action="locateus.php" method="post">
	<div class="sucontainer" style="background-image:url(3.jpg)">
		<ul style="background-image:url(3.jpg)">			
			<label><b>ค้นหาหมอ</b></label>
			<input type="text" name="doctorname" placeholder="ใส่ชื่อหมอ"></input>
		...
		<option value="">เลือก เมือง</option>
		<?php
		...
		<option value="">เลือก คลินิก</option>
		</select><br>
		<div class="container">
