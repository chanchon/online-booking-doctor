...
<body style="background-image:url(2.jpg)">
	...
	<div>
		...
		<label style="font-size:20px"><b>หมอ:</b></label><br>
...
?>		
			...
			<button type="submit" style="position:center" name="submit2" value="Submit">ยืนยันการเปลี่ยนแปลง</button></form>		
<?php
}
require_once("dbconfig.php");
			if(isset($_POST['submit2']))
		{
			...
			{	
				...
				{
							echo "$fnm[$j] :อัปเดตสถานะเรียบร้อยแล้ว..!!<br>";
