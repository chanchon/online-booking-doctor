...
if(isset($_POST['submit']))
{
		...
		echo "<label><b>ชื่อคลินิก:".$row1['name']."</b><br><b>ที่อยู่:<b>".$row1['address']."<br><b>การติดต่อ:<b>".$row1['contact']."<br><b>ชื่อหมอ:<b>".$row2['name']."<br><b>Specialization:<b>".$row2['specialization']."<br><b>การติดต่อหมอ:<b>".$row2['contact']."</label>"; 
}
?>
	</form>
</body>
